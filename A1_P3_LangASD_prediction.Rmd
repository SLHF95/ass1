...
Plot:
```{r}
mlu_TD = ggplot(data = TD_meanMLU_est, aes(x = VISIT, y = MLU_est)) + geom_bar(stat = "identity", width = 1, fill = "grey")
mlu_TD_andBernie = mlu_TD + geom_line(data = Bernie, aes(x = as.numeric(VISIT), y = CHI_MLU), colour = "red")
mlu_TD_andBernie
```
