...
#???d1 = rename(d1, c("MullenRaw" = "nonVerbalIQ", "ExpressiveLangRaw" = "verbalIQ"))
...
```{r}
filter(dfAll, CHI_MLU > 2.7) ??
MLUacross = by(dfAll$CHI_MLU, dfAll$SUBJ1, FUN = mean)
MLUacross[MLUacross > 2.7]
